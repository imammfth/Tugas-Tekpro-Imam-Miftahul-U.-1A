    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread t1 = new Thread(() -> {
            synchronized (acc1) { // Mengunci acc1
                ...
                synchronized (acc2) { // Mengunci acc2
                    System.out.println("Thread 1: Mengunci acc2, memproses transfer dari acc1 ke acc2.");
        ...
        Thread t2 = new Thread(() -> {
            ...
            synchronized (acc1) { // Mengunci acc1 terlebih dahulu
                System.out.println("Thread 2: Mengunci acc1, bersiap transfer...");
                try { Thread.sleep(100); } catch (Exception e) {}

                synchronized (acc2) { // Mengunci acc2 kemudian
                    System.out.println("Thread 2: Mengunci acc2, memproses transfer dari acc2 ke acc1.");
